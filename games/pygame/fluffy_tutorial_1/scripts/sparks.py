...
class Spark:
    def __init__(self, position, angle, speed) -> None:
    ...
    def render(self, surface, offset=(0, 0)):
        render_points = [
            ...
            (self.position[0] + math.cos(self.angle + math.pi * 0.5) * self.speed * 3 - offset[0], self.position[1] + math.sin(self.angle + math.pi * 0.5) * self.speed * 3 - offset[1]),
